...
Dokumen ini menjelaskan cara menayangkan project `dashboard-web` melalui Vercel atau Cloudflare Workers. Keduanya dapat memakai custom domain dan deploy otomatis dari Git.
...
3. Jika repository berisi beberapa project, isi **Root Directory** dengan `dashboard-web`. Jika isi repository langsung merupakan project ini, biarkan kosong.
